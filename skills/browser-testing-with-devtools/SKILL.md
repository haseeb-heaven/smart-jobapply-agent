...
## Smart JobApply Agent restriction

Use this skill only for this project's localhost UI with synthetic data and an
isolated Chrome profile. Never attach it to logged-in LinkedIn, Indeed, email,
resume, or daily-browser sessions. Job-board tab review is governed exclusively
by `skills/easy-apply-tab-monitor/SKILL.md`. DevTools evidence complements, but
does not replace, tracked Playwright tests.
